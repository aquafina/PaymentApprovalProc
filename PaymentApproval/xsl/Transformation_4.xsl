    ...
    <top:XxPaymentApprovalCommentsCollection>
      <xsl:for-each select="/ns1:task_1/ns1:userComment">
        <top:XxPaymentApprovalComments>
          <top:commentId>
            <xsl:value-of select='oraext:sequence-next-val("xx_approval_comments_Seq","jdbc:oracle:thin:apps/mskiz145@192.168.0.80:1523:erpclone")'/>
          </top:commentId>
          <top:commentText>
