...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.8(build 150622.2350.0222) AT [WED APR 20 14:26:32 PKT 2016]. -->
?>
    ...
    <top:XxPaymentApprovalCommentsCollection>
      <xsl:for-each select="/ns1:task_1/ns1:userComment">
        <top:XxPaymentApprovalComments>
          <top:commentId>
            <xsl:value-of select='oraext:sequence-next-val("xx_approval_comments_Seq","jdbc:oracle:thin:apps/mskiz145@192.168.0.30:1526:icterp")'/>
          </top:commentId>
          <top:commentText>
